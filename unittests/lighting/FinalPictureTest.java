...
public class FinalPictureTest {
    ...
    Camera camera = new Camera(new Point(3000, -550, 100), new Vector(1, 1, -0.1), new Vector(1, 1, 20)) //
    ...
    public void SoftShadowOwnPicture() {
        ...
        //----------------Room-----------------
        //floor
        AddRectangle(new Point(0,0,0), new Point(0,4000,0), new Point(4000,4000,0), new Point(0,4000,0),
