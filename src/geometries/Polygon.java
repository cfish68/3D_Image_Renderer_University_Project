...
//   @Override //TODO: maybe can delete
...
//   }
   ...
   public BoundingRegion setBoundingRegion() {
      ...
      //set the min max to be the first point...
      ...
      boundingRegion.max =  new Point(maxX, maxY, maxZ);
      boundingRegion.min = new Point(minX, minY, minZ);
