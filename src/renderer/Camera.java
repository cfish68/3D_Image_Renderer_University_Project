...
public class Camera {
    ...
    public Ray constructRay(int nX, int nY, int j, int i){
        ...
        //NOTICE!!! this could also be the 'top right corner. It'll still work just from the opposite direction.
        ...
        //Below finds the center of the correct pixel by scaling the right and up vectors with the expansion
        // (W*(J + 0.5)) = (W*J + W*0.5) which finds the right pixel and then adds half the pixel to get the middle.
